...
class Application_Form_Shipping extends ZFDoctrine_Form_Model
{
    ...
    protected $_ignoreFields = array('shipping','user_id');
    ...
    {
    	$this->addElement('hidden','form',array('value'=>'shipping'));
    }
    ...
    {	
    	...
    	$save->onclick = "return saveOnePage('shipping')";
